...
def parser():
    ...
    parser.add_argument(
        ...
        nargs=1,
        type=int,
        help='limit the amount of output words')
    ...
    group_input.add_argument(
        ...
        nargs=1,
        type=str,
        help='Setting path to the input data file')
    group_input.add_argument(
        '-io',
        '--default_input',
        action='store_true',
        help='Read from the default file')
    ...
    group_output.add_argument(
        ...
        nargs=1,
        type=str,
        help='Setting path to the output data file')
    group_output.add_argument(
        '-do',
        '--default_output',
        action='store_true',
        help='Result to the default file')
